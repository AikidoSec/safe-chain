...
```shell
curl -fsSL https://github.com/AikidoSec/safe-chain/releases/download/1.5.10/install-safe-chain.sh | sh -s -- --install-dir /usr/local/.safe-chain
```

### Windows

```powershell
iex "& { $(iwr 'https://github.com/AikidoSec/safe-chain/releases/download/1.5.10/install-safe-chain.ps1' -UseBasicParsing) } -InstallDir 'C:\ProgramData\safe-chain'"
```
...
```shell
curl -fsSL https://github.com/AikidoSec/safe-chain/releases/download/1.5.10/install-safe-chain.sh | sh -s -- --ci
```

### Windows (Azure Pipelines, etc.)

```powershell
iex "& { $(iwr 'https://github.com/AikidoSec/safe-chain/releases/download/1.5.10/install-safe-chain.ps1' -UseBasicParsing) } -ci"
```
...
- name: Install safe-chain
  run: curl -fsSL https://github.com/AikidoSec/safe-chain/releases/download/1.5.10/install-safe-chain.sh | sh -s -- --ci
...
- script: curl -fsSL https://github.com/AikidoSec/safe-chain/releases/download/1.5.10/install-safe-chain.sh | sh -s -- --ci
