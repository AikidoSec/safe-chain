...
# Configuration
$InstallUrl = "https://github.com/AikidoSec/safechain-internals/releases/download/v1.7.20/EndpointProtection.msi"
$DownloadSha256 = "bd03950e13f1f16bd69050125436480535a2cfc23c4358592a81fb86557fd75f"
