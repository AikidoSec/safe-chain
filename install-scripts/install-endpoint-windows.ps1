...
# Configuration
$InstallUrl = "https://github.com/AikidoSec/safechain-internals/releases/download/v1.7.31/EndpointProtection.msi"
$DownloadSha256 = "f7ff192137a1d819144481028765eb6976ca9e0f3532f24aff2c68edfca32413"
