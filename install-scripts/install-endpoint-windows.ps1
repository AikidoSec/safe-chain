...
# Configuration
$InstallUrl = "https://github.com/AikidoSec/safechain-internals/releases/download/v1.7.27/EndpointProtection.msi"
$DownloadSha256 = "91b42251ee318d2dc98a1f0e9d89d4e63d0e4fc2409ce8899dede33c105c9be6"
