...
# Configuration
$InstallUrl = "https://github.com/AikidoSec/safechain-internals/releases/download/v1.7.18/EndpointProtection.msi"
$DownloadSha256 = "4cdcdd226448a99519f164996ba7146e858d696f50ad4f50902bfb20e174a27d"
