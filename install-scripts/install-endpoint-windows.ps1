...
# Configuration
$InstallUrl = "https://github.com/AikidoSec/safechain-internals/releases/download/v1.7.14/EndpointProtection.msi"
$DownloadSha256 = "94b73c3b9d8bd5288829b62633613c6f7aa64e8a7a983850af217518ca32aa6f"
