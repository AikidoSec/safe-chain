...
# Configuration
$InstallUrl = "https://github.com/AikidoSec/safechain-internals/releases/download/v1.6.4/EndpointProtection.msi"
$DownloadSha256 = "e8aab6830cfb7deae61f31b426198f602f5a92ce86b25eb4480dc180745df281"
